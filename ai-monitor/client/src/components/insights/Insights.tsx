...
const DEMO_RESULT: AnalysisResult = {
  ...
  isDemo: true,
  team: {
    summary: 'El equipo de 6 desarrolladores registró 53 sesiones demo con un costo total de $21.15. Ana García lidera en volumen y Sofía Martínez en diversidad de tareas. La brecha mayor está entre Diego Romero (score 51) y Ana García (score 70), lo que indica adopción desigual a trabajar. El equipo cubre todos los tipos de tarea disponibles, señal de madurez colectiva.',
    strengths: ['Cobertura completa de tipos de tarea entre los 6 devs', 'Ana y Sofía muestran constancia y volumen destacados', 'Buena distribución del costo mensual sin outliers extremos'],
    recommendations: ['Ana y Sofía deben compartir su metodología en una sesión de knowledge sharing', 'Diego y Martín necesitan aumentar su frecuencia diaria — fijar mínimo de 3 sesiones/día', 'Conectar sesiones de IA con tickets cerrados para medir impacto real en entregables'],
  },
  developers: [
    { name: 'Ana García',      color: '#818cf8', productivityScore: 78, problemSolvingScore: 62, total: 8,  activeDays: 6, sessionsPerDay: 3.2, consistencyScore: 72, totalCost: 4.51, costPerSession: 0.56, debugRatio: 25, avgDebugComplexity: 4200, taskDiversityScore: 80,  topTask: 'Código',      projects: 4, analysis: 'Ana muestra un perfil de alto volumen. Con 3.2 sesiones/día es la más activa del equipo. El 25% de sus sesiones son de debug. Costo por sesión dentro del promedio.',               strengths: ['Mayor volumen de output del equipo', 'Consistencia diaria destacada (72%)'],          weaknesses: ['Ratio de revisión de código bajo'],                                            recommendation: 'Destinar el 20% de sesiones a revisión de código propio antes de hacer commit para reducir el ciclo de debug.' },
    { name: 'Carlos López',    color: '#fbbf24', productivityScore: 64, problemSolvingScore: 82, total: 7,  activeDays: 5, sessionsPerDay: 2.4, consistencyScore: 58, totalCost: 5.44, costPerSession: 0.77, debugRatio: 43, avgDebugComplexity: 7800, taskDiversityScore: 100, topTask: 'Debug',       projects: 3, analysis: 'Carlos muestra un perfil de resolución de problemas. Sus sesiones de debug son las más complejas del equipo. Alta diversidad de tipos de tarea. Costo por sesión sobre el promedio.',  strengths: ['Mayor profundidad en resolución de bugs', 'Alta diversidad de tareas (5 tipos)'], weaknesses: ['Costo por sesión elevado vs el promedio'],                                      recommendation: 'Reducir el tamaño del contexto enviado. Prompts más focalizados bajan el costo y mejoran la calidad.' },
    { name: 'Martín Silva',    color: '#38bdf8', productivityScore: 50, problemSolvingScore: 65, total: 5,  activeDays: 3, sessionsPerDay: 1.8, consistencyScore: 38, totalCost: 0.52, costPerSession: 0.10, debugRatio: 20, avgDebugComplexity: 2100, taskDiversityScore: 60,  topTask: 'Explicación', projects: 2, analysis: 'Martín muestra un perfil en desarrollo. El promedio de 1.8 sesiones/día indica uso esporádico. Solo activo 3 de 30 días del período. Mejor costo/valor del equipo.',             strengths: ['Mejor costo/valor del equipo', 'Bajo ratio de debug (20%)'],                      weaknesses: ['Baja consistencia diaria — solo activo 3 días', 'Pocos proyectos distintos'],    recommendation: 'Establecer mínimo 3 sesiones de IA por día hábil para construir el hábito y el contexto acumulado.' },
    { name: 'Laura Fernández', color: '#34d399', productivityScore: 68, problemSolvingScore: 71, total: 11, activeDays: 7, sessionsPerDay: 2.8, consistencyScore: 65, totalCost: 3.18, costPerSession: 0.29, debugRatio: 27, avgDebugComplexity: 3800, taskDiversityScore: 80,  topTask: 'Código',      projects: 3, analysis: 'Laura tiene un perfil equilibrado con buena constancia. Sus sesiones son eficientes en costo y cubre bien distintos tipos de tarea. Destaca en Mobile App con foco en implementación.', strengths: ['Buen equilibrio costo/output', 'Constancia diaria sostenida (65%)'],               weaknesses: ['Sesiones de debug de complejidad media — podría profundizar más'],              recommendation: 'Incorporar sesiones de revisión de código de pares para elevar la calidad colectiva del equipo.' },
    { name: 'Diego Romero',    color: '#f87171', productivityScore: 45, problemSolvingScore: 58, total: 6,  activeDays: 4, sessionsPerDay: 1.5, consistencyScore: 42, totalCost: 0.68, costPerSession: 0.11, debugRatio: 33, avgDebugComplexity: 2900, taskDiversityScore: 60,  topTask: 'Debug',       projects: 2, analysis: 'Diego tiene el menor volumen del equipo pero sesiones de buena calidad. El 33% de debug sugiere que enfrenta problemas no triviales. Con mayor frecuencia diaria su score subiría rápido.', strengths: ['Costo por sesión muy bajo', 'Buen ratio debug/complejidad'],                       weaknesses: ['Menor frecuencia de uso diario del equipo', 'Baja consistencia entre semanas'], recommendation: 'Incorporar la IA en tareas cotidianas menores (autocomplete de tests, generación de mocks) para aumentar la frecuencia sin esfuerzo extra.' },
    { name: 'Sofía Martínez',  color: '#fb923c', productivityScore: 74, problemSolvingScore: 68, total: 16, activeDays: 8, sessionsPerDay: 3.0, consistencyScore: 68, totalCost: 6.82, costPerSession: 0.43, debugRatio: 22, avgDebugComplexity: 3200, taskDiversityScore: 100, topTask: 'Código',      projects: 4, analysis: 'Sofía es la segunda en volumen total y cubre todos los tipos de tarea disponibles, señal de uso maduro y variado. Sus proyectos de E-commerce requieren alta complejidad. Costo controlado.', strengths: ['Mayor diversidad de tareas del equipo (5 tipos)', 'Alto volumen con costo controlado'], weaknesses: ['Costo mensual proyectado es el más alto del equipo'],                            recommendation: 'Revisar si algunos contextos enviados pueden simplificarse; reducir un 15% el costo sin perder calidad mejoraría el ROI.' },
  ],
};
