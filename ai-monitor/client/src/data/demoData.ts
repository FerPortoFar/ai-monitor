...
export const DEMO_SESSIONS: Session[] = [
  { ts: '17:42', devIndex: 0, task: 'Código',     model: 'Sonnet 4.6', inputTokens: 3240,  outputTokens: 1120, costUSD: 0.22 },
  { ts: '17:28', devIndex: 1, task: 'Debug',       model: 'Haiku 4.5', inputTokens: 1840,  outputTokens: 560,  costUSD: 0.06 },
  { ts: '17:15', devIndex: 0, task: 'Revisión',    model: 'Sonnet 4.6', inputTokens: 2100,  outputTokens: 840,  costUSD: 0.16 },
  { ts: '16:58', devIndex: 2, task: 'Explicación', model: 'Sonnet 4.6', inputTokens: 4200,  outputTokens: 1680, costUSD: 0.32 },
  { ts: '16:44', devIndex: 0, task: 'Código',      model: 'Sonnet 4.6', inputTokens: 5600,  outputTokens: 1900, costUSD: 0.42 },
  { ts: '16:32', devIndex: 1, task: 'Docs',        model: 'Haiku 4.5', inputTokens: 920,   outputTokens: 380,  costUSD: 0.03 },
  { ts: '16:18', devIndex: 2, task: 'Debug',       model: 'Opus 4.6',  inputTokens: 1560,  outputTokens: 480,  costUSD: 0.08 },
  { ts: '16:05', devIndex: 0, task: 'Código',      model: 'Sonnet 4.6', inputTokens: 7840,  outputTokens: 2640, costUSD: 0.58 },
  { ts: '15:52', devIndex: 1, task: 'Explicación', model: 'Sonnet 4.6', inputTokens: 3120,  outputTokens: 1040, costUSD: 0.24 },
  { ts: '15:38', devIndex: 0, task: 'Debug',       model: 'Haiku 4.5', inputTokens: 2200,  outputTokens: 720,  costUSD: 0.08 },
  { ts: '15:24', devIndex: 2, task: 'Código',      model: 'Sonnet 4.6', inputTokens: 4800,  outputTokens: 1560, costUSD: 0.36 },
  { ts: '15:10', devIndex: 1, task: 'Revisión',    model: 'Sonnet 4.6', inputTokens: 1840,  outputTokens: 620,  costUSD: 0.14 },
  { ts: '14:55', devIndex: 0, task: 'Código',      model: 'Opus 4.6',  inputTokens: 38600, outputTokens: 12400, costUSD: 2.18 },
  { ts: '14:42', devIndex: 2, task: 'Docs',        model: 'Haiku 4.5', inputTokens: 1100,  outputTokens: 440,  costUSD: 0.04 },
  { ts: '14:28', devIndex: 0, task: 'Explicación', model: 'Sonnet 4.6', inputTokens: 2800,  outputTokens: 940,  costUSD: 0.20 },
  { ts: '14:15', devIndex: 1, task: 'Código',      model: 'Sonnet 4.6', inputTokens: 62000, outputTokens: 21000, costUSD: 5.01 },
  { ts: '14:02', devIndex: 2, task: 'Debug',       model: 'Haiku 4.5', inputTokens: 1680,  outputTokens: 520,  costUSD: 0.05 },
  { ts: '13:48', devIndex: 0, task: 'Código',      model: 'Sonnet 4.6', inputTokens: 8900,  outputTokens: 3100, costUSD: 0.72 },
  { ts: '13:35', devIndex: 1, task: 'Explicación', model: 'Haiku 4.5', inputTokens: 2400,  outputTokens: 820,  costUSD: 0.07 },
  { ts: '13:22', devIndex: 0, task: 'Revisión',    model: 'Sonnet 4.6', inputTokens: 3100,  outputTokens: 1040, costUSD: 0.23 },
];
